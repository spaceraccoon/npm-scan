...
module.exports = function printResults (results) {
  ...
  console.log(`\nFound \x1b[31m${totalVulns}\x1b[0m vulnerabilit${totalVulns === 1 ? 'y' : 'ies'} (${lowVulns} low, ${medVulns} \x1b[33mmedium\x1b[0m, ${highVulns} \x1b[31mhigh\x1b[0m) in ${Object.keys(results).length} scanned packages.`)
}
